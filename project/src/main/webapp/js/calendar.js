...
YAHOO.util.Event.onDOMReady(function() {
    ...
    var inTxt = YAHOO.util.Dom.get("ask_in"),
        outTxt = YAHOO.util.Dom.get("ask_out"),
...
YAHOO.util.Event.onDOMReady(function() {
    ...
    var cal = new YAHOO.example.calendar.IntervalCalendar("cal2Container", {pages:2});
...
YAHOO.util.Event.onDOMReady(function() {
    ...
    var inTxt = YAHOO.util.Dom.get("note_in"),
        outTxt = YAHOO.util.Dom.get("note_out"),
        inDate, outDate, interval;

    inTxt.value = "";
    outTxt.value = "";

    var cal = new YAHOO.example.calendar.IntervalCalendar("cal3Container", {pages:2});
...
YAHOO.util.Event.onDOMReady(function() {
    ...
    var inTxt = YAHOO.util.Dom.get("eve_in"),
        outTxt = YAHOO.util.Dom.get("eve_out"),
        inDate, outDate, interval;

    inTxt.value = "";
    outTxt.value = "";

    var cal = new YAHOO.example.calendar.IntervalCalendar("cal4Container", {pages:2});
...
YAHOO.util.Event.onDOMReady(function() {
    ...
    var inTxt = YAHOO.util.Dom.get("shop_in"),
        outTxt = YAHOO.util.Dom.get("shop_out"),
        inDate, outDate, interval;

    inTxt.value = "";
    outTxt.value = "";

    var cal = new YAHOO.example.calendar.IntervalCalendar("cal5Container", {pages:2});

								...
								<div class="container" style="width: 100%;">
									<div class="row">
										...
										<form id="frm" enctype="multipart/form-data" method="post" action="./Cook/Create">
											...
											<input type="hidden" name="url" value="CookBox">
											<!-- 모달 시작 -->
														...
														<div class="row">
															<c:forEach items="${cook }" var="ckList">
																<div class="col-sm-3" style="margin-top: 10px;">
																	<div class="row"><label>No.${ckList.cno } ${ckList.title }</label></div>
															...
															<div class="text-center">
																<ul class="pagination">
																	<c:if test="${pageMaker.prev }">
																		<li>
																			<a href="CookBox?page=${pageMaker.startPage-1 }">&laquo;</a>
																		</li>
																	</c:if>
																	<c:forEach begin="${pageMaker.startPage }" end="${pageMaker.endPage }" var="idx">
																		<li
																			<c:out value="${pageMaker.cri.page==idx?'class=active':''}"/>>
																			<a href="CookBox?page=${idx }">${idx }</a>
																		</li>
																	</c:forEach>
																	<c:if test="${pageMaker.next && pageMaker.endPage > 0 }">
																		<li>
																			<a href="CookBox?page=${pageMaker.startPage+1 }">&raquo;</a>
																		</li>
																	</c:if>
																</ul>
															</div>
